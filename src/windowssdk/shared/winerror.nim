...
implementDistinctEnum(FacilityCode, defined(useWinErrorStringify)):
  const
...
implementDistinctEnum(WinError, defined(useWinErrorStringify)):
  const
...
implementDistinctEnum(HResult, defined(useWinErrorStringify)):
  const
