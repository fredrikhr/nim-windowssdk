...
when defined(useWindowsSdk):
  ...
  {.pragma: typeImportc, importc, header: sdkHeader.}
else:
  {.pragma: typeImportc.}

whenUseWindowsSdk:
  {.importc: "IID_IUnknown", header: sdkHeader.}
...
whenUseWindowsSdk:
  {.importc: "IUnknown_QueryInterface", header: sdkHeader.}
  proc queryInterface*(this: ptr IUnknown, riid: ptr Iid, ppvObject: pointer): HResult = 
    this.lpVtbl.queryInterface(this, riid, ppvObject)
  {.importc: "IUnknown_AddRef", header: sdkHeader.}
  proc addRef*(this: ptr IUnknown): HResult = 
    this.lpVtbl.addRef(this)
  {.importc: "IUnknown_Release", header: sdkHeader.}
  proc release*(this: ptr IUnknown): HResult = 
    this.lpVtbl.release(this)

whenUseWindowsSdk:
  {.importc: "IID_AsyncIUnknown", header: sdkHeader.}
...
whenUseWindowsSdk:
  {.importc: "AsyncIUnknown_Begin_QueryInterface", header: sdkHeader.}
  proc begin_QueryInterface*(this: ptr AsyncIUnknown, riid: ptr Iid): HResult =
    this.lpVtbl.begin_QueryInterface(this, riid)
  {.importc: "AsyncIUnknown_Finish_QueryInterface", header: sdkHeader.}
